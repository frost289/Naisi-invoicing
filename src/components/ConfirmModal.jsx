      ...
      {isOpen ? (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-md rounded-2xl border border-line/70 bg-surface p-6 shadow-card"
          >
            ...
            <div className="mt-5 flex justify-end gap-3">
              <button
                type="button"
                onClick={onCancel}
                className="rounded-lg border border-line/80 px-4 py-2 text-sm font-semibold transition hover:bg-cream"
              >
                Cancel
              </button>
              <button
